...
examples. The [eusebeia](https://eusebeia.dyndns.org/4d/index) website is 
...
tilings of the Poincaré disk, and the `hdelaunay` function to construct 
hyperbolic Delaunay triangulations of the Poincaré disk. They are constructed 
with the C++ library **CGAL**.
