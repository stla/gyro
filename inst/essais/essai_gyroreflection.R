...
Mgyroreflection <- function(A, B, M, s) {
  circle <- gyro:::circumcircle(A, B, gyro:::Mgyromidpoint(A, B, s))
  gyro:::inversion(circle, M)
}
...
#' @description Gyroreflection of a point in a 2D gyrospace.
#'
#' @encoding UTF-8
#'
